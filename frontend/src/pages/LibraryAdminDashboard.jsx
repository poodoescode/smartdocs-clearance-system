    ...
    <div className="min-h-screen bg-[#020617]">
      ...
      <div className={`${sidebarOpen ? 'ml-64' : 'ml-20'} transition-all duration-300`}>
        ...
        <div className="h-16 bg-slate-900/40 backdrop-blur-xl border-b border-white/5 flex items-center justify-between px-6 shadow-lg sticky top-0 z-40">
          <div>
            <h1 className="text-xl font-bold text-white">Library Dashboard</h1>
        ...
        <div className="p-8 relative z-10">
          <div className="mb-6">
            <h2 className="text-2xl font-bold text-white mb-2">Pending Library Clearances</h2>
            <p className="text-slate-400">Review students who have completed professor approvals</p>
          </div>
          ...
          {loading ? (
            ...
            <GlassCard className="p-12 text-center">
              ...
              <p className="text-slate-400">No pending library clearances</p>
            </GlassCard>
          ) : (
                  ...
                  {!selectedRequest ? (
                    ...
                    <div className="flex flex-col h-full">
                      <div className="p-6 border-b border-white/5 bg-gradient-to-b from-indigo-500/10 to-transparent">
                        ...
                        <div className="grid grid-cols-2 gap-3">
                          ...
                          <div className="p-3 rounded-xl bg-black/20 border border-white/5">
                            ...
                            <p className="text-xs font-bold text-emerald-400">Professors Approved</p>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="flex-1 overflow-y-auto p-6 space-y-4">
                        <div>
                          ...
                          <textarea
                            ...
                            rows="4"
                            placeholder="Add comments about library obligations, unsettled books, etc..."
                          />
                        </div>
                      </div>
                      ...
                      <div className="p-6 border-t border-white/5 bg-black/20 space-y-3">
                        ...
                        >
                          {actionLoading ? 'Processing...' : '✓ Approve Library Clearance'}
                        </button>
                        <button
