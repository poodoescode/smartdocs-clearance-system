        ...
        <div className="spatial-glass rounded-2xl p-6 border border-gray-200/50">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-600 font-medium">Active Clearances</p>
            </div>
          </div>
        </div>
...
// New Clearance View Component
function NewClearanceView({ clearanceTypes, selectedClearanceType, setSelectedClearanceType, handleCreateRequest, loading, setActiveView }) {
  return (
        ...
        <form onSubmit={handleCreateRequest} className="space-y-6">
          <div>
            <label className="block text-sm font-bold text-gray-700 mb-2 ml-1">
              Select Clearance Type <span className="text-red-500">*</span>
            </label>
            <select 
            ...
            >
              ...
              {clearanceTypes.map(clearance => (
                <option key={clearance.id} value={clearance.id}>
                  {clearance.name} ({clearance.stages.join(' → ')})
                </option>
              ))}
            </select>
          </div>
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      {requests.length === 0 ? (
        <div className="spatial-glass rounded-3xl p-12 text-center border border-gray-200/50">
          ...
          <p className="text-gray-600 text-lg font-semibold mb-2">No clearance requests yet</p>
          <p className="text-gray-400 text-sm">Submit your first clearance request to get started</p>
        </div>
      ) : (
